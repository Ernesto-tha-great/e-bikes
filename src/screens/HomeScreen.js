...
const HomeScreen = ({navigation}) => {
    ...
    return (
        <View style={tw`bg-white flex-1`}>
            ...
            <View style={{marginLeft:-30, marginVertical: 4, marginBottom: 4,  }}>
                <Carousel
                    layout="default"
                    ref={isCarousel}
                    data={data}
            ...
            <View style={[tw` bg-yellow-400 py-8 mt-6`,{flexDirection:"row", justifyContent:"space-between"}]}>
               
                  <View style={tw`left-5`}> 
                  ...
                  <View style={[tw`bg-black rounded-full px-8 py-2 mr-4  `, {flexDirection:"row", }]}>
                      <TouchableOpacity onPress={() => navigation.navigate("Explore")} style={{flexDirection:"row", paddingVertical: 8}}> 
                          <Text style={tw`text-white font-semibold text-xl right-4`}>Your Orders</Text>
                          <View >
                          <AntDesign style={tw`left-5`} name="arrowright" size={34} color="white"  />
                          </View>
                      </TouchableOpacity>
                   </View>
            </View>
